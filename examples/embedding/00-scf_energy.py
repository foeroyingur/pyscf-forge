...
The environment is described by an MM potential -- a PyFraME JSON file holding
the multipoles and polarizabilities of the classical sites, together with the
...
# MM potential is a PyFraME JSON file describing the classical sites and the
# nuclei of the quantum region, in the units its "units" block states. A
# potential PyFraME has just built can also be given as the system itself; see
# 02-potential_from_pyframe.py.
...
# it is the "potential" entry. Both restricted and unrestricted references are
